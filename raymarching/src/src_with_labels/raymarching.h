...
void composite_rays_train_backward(const at::Tensor grad_weights_sum, const at::Tensor grad_image, const at::Tensor grad_semantic_image, const at::Tensor sigmas, const at::Tensor rgbs, const at::Tensor classes, const at::Tensor deltas, const at::Tensor rays, const at::Tensor num_classes, const at::Tensor weights_sum, const at::Tensor image, const at::Tensor semantic_image, const uint32_t M, const uint32_t N, const float T_thresh, at::Tensor grad_sigmas, at::Tensor grad_rgbs, at::Tensor grad_classes);
